        ...
        <div className="image-text-wrapper">
          ...
          <div className="home-text">
            <p>
                    ...
                    <div className="rominder-info-card">
                      ...
                      <div className="rominder-text-content">
                        ...
                        <p>
                          ...
                          driving growth through innovation and education. Under her
                          leadership, the institute has expanded industry
                          collaborations and modernized programs, preparing students
              ...
              , Director of GTBIT, the institution has continually supported
              such student-led efforts that drive real-world impact and foster
              responsible citizenship. The name SWAAS, meaning breath in Hindi,
              reflects its mission to breathe life into causes that matter, from
              ...
              a sense of responsibility toward the environment. One of
              SWAAS&rsquo; most notable contributions was the Covigo Web
