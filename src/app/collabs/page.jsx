        ...
        <div>
           ...
           <header>
            ...
            <div className="collabs-header">
                ...
                <div className="star1"><img src={'/star.png'} alt="Star" /></div>
                <div className="star2"><img src={'/star.png'} alt="Star" /></div>
                <div className="star3"><img src={'/star.png'} alt="Star" /></div>
                <div className="star4"><img src={'/star.png'} alt="Star" /></div>
            </div><div className="leaf"><img src={'/image-5.png'} alt="Leaf" /></div><div className="content">
                <div className="text">
                    <h2>Loren Ipsum</h2>
            ...
            </div><div className="leaf2"><img src={'/leaf.png'} alt="Leaf" /></div><div className="oval"><img src={'/image-10.png'} alt="Oval" /></div></>
        </div>
    );
};
